package com.dalimao.diudiu.go.common.storage;
...
/**
 * @Title:SharedPreferencesDao
 * @Package:com.dalimao.mytaxi.splash.common.storage
 * @Description:ShraredPreference 数据访问对象
 * @Auther:YJH
